...
KEYWORDS_INTL = [
    ...
    # RECONFIGURADO (2026-08-31, perfil do usuário): nicho sênior de
    # Master Data/Governança/SAP, em inglês — mercado-alvo agora inclui
    # EUA/Reino Unido (ver LOCATIONS_INTL e MERCADOS_REMOTO_ACEITOS_INTL
    # abaixo), que não exigem português/espanhol no anúncio.
    "Master Data Analyst",
    ...
    "SAP MDG Specialist",
    # RECONFIGURADO (2026-08-31): raiz "solta" — mesma generalização feita
    # em config.py (ver comentário lá).
    "Data Governance",
    "Master Data",
    "Master Data Management",
    # RECONFIGURADO (2026-08-31): puxado do headline atual do LinkedIn do
    # usuário (frente de Governança de IA/Prompt Engineering) e de
    # processos-seletivos.md (cargos de vagas internacionais já aplicadas
    # — LawnStarter). Ver comentário equivalente em config.py.
...
TERMOS_BUSCA_INTL = [
    ...
    "spanish market",
    "latam",
    # RECONFIGURADO (2026-08-31, perfil do usuário): termos SEM
    # exigência de idioma — só fazem sentido porque agora são escopados
    # por país aceito (Estados Unidos/Reino Unido, ver LOCATIONS_INTL
    # abaixo), mesma lógica já validada pra "business analyst"/"data
    # analyst"/"business intelligence" logo acima.
    "master data analyst",
    "data governance analyst",
    "sap mm analyst",
    "master data management",
    ...
    "sap business analyst",
    "material master data coordinator",
    # RECONFIGURADO (2026-08-31) — ver os mesmos termos em KEYWORDS_INTL
    # acima pro contexto (headline do LinkedIn + processos-seletivos.md).
    "data governance",
    "master data",
    "logistics operations analyst",
    "ai governance",
...
# RECONFIGURADO (2026-08-31, perfil do usuário): "United States" e
# "United Kingdom" foram REMOVIDOS na versão original (ver comentário
# acima) porque location não filtra idioma, e a maioria das vagas de lá
# pede inglês fluente — problema real pra quem buscava vaga em português/
# espanhol. Não é o caso aqui: perfil atual tem inglês fluente e já tem
# oportunidade remota em USD desse exato mercado (LawnStarter, EUA). Volta
# a entrar, com job.py já reconhecendo "Estados Unidos"/"Reino Unido" como
# mercado (ver _MERCADOS_REMOTO em job.py — a lógica sempre existiu, só não
# era usada por estar fora desta lista e de MERCADOS_REMOTO_ACEITOS_INTL).
LOCATIONS_INTL = [
    "Spain",
    "Portugal",
    "Mexico",
...
MERCADOS_REMOTO_ACEITOS_INTL = [
    ...
    # LOCATIONS_INTL acima pro contexto.
    "Estados Unidos",
    "Reino Unido",
]
...
DOMINIOS_INDEED_INTL = {
    ...
    "Chile": "cl.indeed.com",
    # RECONFIGURADO (2026-08-31, perfil do usuário) — ver
    # LOCATIONS_INTL acima. Indeed Intl está desligado nos perfis (ver
    # _SCRAPERS_INTL em perfis.py, mesmo bloqueio medido do Indeed BR), mas
    # o domínio fica definido pra quando/se ele voltar a responder.
