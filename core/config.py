...
KEYWORDS_CARGO_FORTE = [
    ...
    "Analista de Datos",
    "Analítica de Datos",
    # RECONFIGURADO (2026-08-31, perfil do usuário): projeto
    # herdado de outra usuária, cargo-alvo era genérico Dados/BI júnior-
    # pleno. Perfil atual é sênior em Master Data Management, Governança de
    # Dados (DAMA-DMBOK) e SAP MM/S4HANA — bloco abaixo cobre esse nicho,
    # sem remover nada do que já existia (ele também aplica pra BI puro,
    # ex: Grupo Boticário/Analista de BI e Insights).
    "Analista de Master Data",
    "Master Data Analyst",
    "Coordenador de Master Data",
    "Master Data Coordinator",
    "Material Master Data Coordinator",
    ...
    "SAP MM Consultant",
    "SAP MDG Specialist",
    # RECONFIGURADO (2026-08-31): raiz "solta" (sem sufixo Analyst/
    # Specialist/Coordinator) — pega variação de título que os termos
    # compostos acima não cobrem (ex: "... Governance Manager/Lead/
    # Director"), mesmo raciocínio de generalização das entradas de cima.
    "Governança de Dados",
    "Data Governance",
    "Master Data",
    "Master Data Management",
    # RECONFIGURADO (2026-08-31): puxado do headline atual do LinkedIn do
    # usuário ("Senior Master Data & Logistics Operations Analyst | Data
    # Governance (MDM) & AI Governance | LLM, Agentic AI & Prompt
    # Engineering | SAP, KNIME & Power BI") — frente de Governança de IA/
    # Prompt Engineering que o perfil já assumiu publicamente e a lista
    # antiga (presa em Master Data/SAP/BI) não cobria.
    ...
    "Prompt Engineering",
    "Prompt Engineer",
    # RECONFIGURADO (2026-08-31): puxado de processos-seletivos.md — cargos
    # de vagas reais já aplicadas que a lista anterior não cobria (Nestlé/
    # CDT, LawnStarter, Braveo, Azul — ver Controle_Candidaturas.md).
    "Analista de Previsão Comercial",
...
KEYWORDS_CARGO_AMBIGUO = [
    ...
    "Analyst",
    # RECONFIGURADO (2026-08-31, perfil do usuário): "Coordenador"/
    # "Product Owner" existem em qualquer área (obras, RH, marketing...) —
    # só contam com QUALIFICADORES_DADOS junto no título (ex: "Coordenador
    # de Master Data", "Product Owner de Dados"). Cobre também o caso sem
    # qualificador de dados explícito via a rota de FERRAMENTAS_TITULO+
    # QUALIFICADORES_CARGO abaixo (ex: "Coordenador de Tecnologia Logística
    # | Projetos SAP TM" — bate por "sap" + "coordenador").
    "Coordenador",
    "Coordinator",
    "Product Owner",
]
...
QUALIFICADORES_DADOS = [
    ...
    "reporting",
    "insights",
    # RECONFIGURADO (2026-08-31, perfil do usuário) — ver
    # KEYWORDS_CARGO_FORTE acima pro contexto do nicho Master Data/
    # Governança/SAP.
    "master data",
    "dados mestres",
    "cadastro",
...
FERRAMENTAS_TITULO = [
    "Power BI",
    # RECONFIGURADO (2026-08-31, perfil do usuário): "SAP" sozinho
    # é o núcleo de muito título de vaga no nicho de Master Data (ex.:
    # "Especialista de Negócios e Sistemas SAP", "Consultor SAP MM"), sem
    # necessariamente ter "dados"/"master data" no título — só entra com
    # QUALIFICADORES_CARGO junto (abaixo), mesma regra de "Power BI".
    "SAP",
    # RECONFIGURADO (2026-08-31): terceira ferramenta do headline do
    # LinkedIn do usuário ("SAP, KNIME & Power BI").
    "KNIME",
]
...
QUALIFICADORES_CARGO = [
    ...
    "consultor",
    "consultant",
    # RECONFIGURADO (2026-08-31, perfil do usuário): perfil sênior
    # também mira vaga de coordenação (ex: "Coordenador de Tecnologia
    # Logística | Projetos SAP TM", Nestlé).
    "coordenador",
    "coordinator",
]
...
# de outra usuária, cujo requisito de cidade era Nordeste (Campina Grande,
# João Pessoa, Recife, Natal, Caruaru, Manaus, Maceió, Aracaju, Fortaleza —
# ver histórico dessa decisão no git). Perfil atual mora em São Paulo/SP
# (Vila Mariana) — só São Paulo entra como presencial/híbrida aceita; vaga
# remota continua sem restrição de cidade (mercado tratado à parte, ver
# MERCADOS_REMOTO_ACEITOS abaixo).
CIDADES = [
    "Remoto",
    "São Paulo",
]
